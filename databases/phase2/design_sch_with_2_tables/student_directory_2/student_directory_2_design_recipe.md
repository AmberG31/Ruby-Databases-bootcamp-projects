...
posts, title, content, comments on posts, comments content, commenter name
```
...
| --------------------- | ------------------  |
| posts                 | title, content
| comments              | coment_content, author_name
...
2. Name of the second table (always plural): `comments` 
    ...
    Column names: `comment_content`, `author_name`, `post_id`
